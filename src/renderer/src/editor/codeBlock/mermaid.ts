...
export function getMermaidConfig() {
  ...
  if (cssVar('--md-mermaid-primary', '') !== '') return { suppressErrorRendering: true, theme: 'base' as const, themeVariables: {
  ...
  return { suppressErrorRendering: true, theme: (isDark ? 'dark' : 'default') as 'dark' | 'default' }
}
