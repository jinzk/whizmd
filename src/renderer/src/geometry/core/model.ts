...
export type GeometryStrokeStyle = { color?: string; lineWidth?: number; lineStyle?: GeometryLineStyle }
export type GeometryCircle = { type: 'circle'; id: string; center: string; radius: number } & GeometryStrokeStyle
export type GeometryEllipse = { type: 'ellipse'; id: string; focusA: string; focusB: string; semiMajor: number } & GeometryStrokeStyle
export type GeometryArc = { type: 'arc'; id: string; center: string; radius: number; startAngle: number; endAngle: number; startAnchor?: string; endAnchor?: string } & GeometryStrokeStyle
